...
var imageData = {};
var imageDataKeys = [];
selectedBrands = 'beneful|nutrish|pedigree|bluebuffalo|iams|eukanuba|royalcanin|kibblesnbits';
...
function loadData() {
  get('brand_counts.json', function(data) {
    ...
    brandCounts = [
    {x: "Beneful", value: brandCountsHolder["beneful"]},
    {x: "Nutrish", value: brandCountsHolder["nutrish"]},
    {x: "Pedigree", value: brandCountsHolder["pedigree"]},
    {x: "Blue Buffalo", value: brandCountsHolder["bluebuffalo"]},
    {x: "IAMS", value: brandCountsHolder["iams"]},
    {x: "Eukanuba", value: brandCountsHolder["eukanuba"]},
    {x: "Royal Canin", value: brandCountsHolder["royalcanin"]},
    {x: "Kibbles 'n Bits", value: brandCountsHolder["kibblesnbits"]}
];
  })    
...
function addWindowEventListeners() {
  ...
  window.addEventListener('hashchange', function(e) {
    ...
    marker.XPos = (((coords.x + 14660)/(16140 + 14660)) * 300) - (marker.Width / 2);
    marker.YPos = (193 - ((coords.y + 8160)/(8496 + 8160)) * 193) - marker.Height;
    ...
    clusterCounts = [
    {x: "Beneful", value: thisClusterData["beneful"]},
    {x: "Nutrish", value: thisClusterData["nutrish"]},
    {x: "Pedigree", value: thisClusterData["pedigree"]},
    {x: "Blue Buffalo", value: thisClusterData["bluebuffalo"]},
    {x: "IAMS", value: thisClusterData["iams"]},
    {x: "Eukanuba", value: thisClusterData["eukanuba"]},
    {x: "Royal Canin", value: thisClusterData["royalcanin"]},
    {x: "Kibbles 'n Bits", value: thisClusterData["kibblesnbits"]}
    ]
...
mapSprite.src = "assets/images/Beneful Full Map.png";
